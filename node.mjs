...
var $;
(function ($) {
    function $bog_stschool_link_synced(Value) {
    ...
    $.$bog_stschool_link_synced = $bog_stschool_link_synced;
    class $bog_stschool_item extends $giper_baza_dict.with({
        Text: $giper_baza_atom_text,
        Key: $giper_baza_atom_text,
    }) {
    }
    $.$bog_stschool_item = $bog_stschool_item;
    class $bog_stschool_task extends $giper_baza_dict.with({
    ...
    $.$bog_stschool_task = $bog_stschool_task;
    class $bog_stschool_slide extends $giper_baza_dict.with({
        After: $giper_baza_atom_real,
        Board: $giper_baza_atom_text,
    }) {
    }
    $.$bog_stschool_slide = $bog_stschool_slide;
    class $bog_stschool_deck extends $giper_baza_dict.with({
        Title: $giper_baza_atom_text,
        File: $bog_stschool_link_synced(() => $giper_baza_file),
        Slides: $giper_baza_list_link.to(() => $bog_stschool_slide),
    }) {
    }
    $.$bog_stschool_deck = $bog_stschool_deck;
    class $bog_stschool_group extends $giper_baza_dict.with({
        Title: $giper_baza_atom_text,
    ...
    $.$bog_stschool_group = $bog_stschool_group;
    class $bog_stschool_member extends $giper_baza_dict.with({
        Name: $giper_baza_atom_text,
        Land: $giper_baza_atom_text,
    }) {
    }
    $.$bog_stschool_member = $bog_stschool_member;
    class $bog_stschool_roster extends $giper_baza_dict.with({
        Members: $giper_baza_list_link.to(() => $bog_stschool_member),
    }) {
    }
    $.$bog_stschool_roster = $bog_stschool_roster;
    class $bog_stschool_reply extends $giper_baza_dict.with({
    ...
    $.$bog_stschool_reply = $bog_stschool_reply;
    class $bog_stschool_student extends $giper_baza_dict.with({
        Name: $giper_baza_atom_text,
    ...
    $.$bog_stschool_student = $bog_stschool_student;
    class $bog_stschool_home extends $giper_baza_dict.with({
        Name: $giper_baza_atom_text,
        Teach: $giper_baza_list_str,
        Learn: $giper_baza_dict_to($giper_baza_atom_text),
    }) {
    }
    $.$bog_stschool_home = $bog_stschool_home;
})($ || ($ = {}));
...
;
	($.$bog_stschool_join) = class $bog_stschool_join extends ($.$mol_page) {
		group_title(){
			return "Группа";
		}
		hint(){
		...
		Enter(){
			...
			(obj.title) = () => ("Войти в группу");
			(obj.enabled) = () => ((this.ready()));
	...
	($mol_mem(($.$bog_stschool_join.prototype), "Hint"));
	($mol_mem(($.$bog_stschool_join.prototype), "name"));
	($mol_mem(($.$bog_stschool_join.prototype), "Name"));
	($mol_mem(($.$bog_stschool_join.prototype), "Name_field"));
	($mol_mem(($.$bog_stschool_join.prototype), "enter"));
	($mol_mem(($.$bog_stschool_join.prototype), "Enter"));
...
var $;
(function ($) {
    class $bog_stschool_room extends $mol_object {
        static of(link) {
        ...
        member_names() {
            ...
            for (const member of this.members()) {
                ...
                if (land)
                    names.set(land, member.Name()?.val() ?? '');
            }
            return names;
        }
        tasks() {
    ...
    __decorate([
        $mol_mem
    ], $bog_stschool_room.prototype, "member_links", null);
    __decorate([
        $mol_mem
    ], $bog_stschool_room.prototype, "member_names", null);
    __decorate([
        $mol_mem
    ], $bog_stschool_room.prototype, "task_links", null);
    __decorate([
        $mol_mem_key
    ], $bog_stschool_room, "of", null);
    $.$bog_stschool_room = $bog_stschool_room;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_join extends $.$bog_stschool_join {
            auto() {
                if (!this.room().my_student_link())
                    return;
        ...
        $$.$bog_stschool_join = $bog_stschool_join;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_edit) = class $bog_stschool_edit extends ($.$mol_expander) {
		current(next){
			if(next !== undefined) return next;
			return false;
		}
		Current(){
			...
			(obj.title) = () => ("На экране");
			(obj.checked) = (next) => ((this.current(next)));
			return obj;
		}
		home(next){
			if(next !== undefined) return next;
		...
		Home(){
			const obj = new this.$.$mol_check_box();
			(obj.title) = () => ("Домашка");
			(obj.checked) = (next) => ((this.home(next)));
			return obj;
		}
		task_title(next){
			if(next !== undefined) return next;
		...
		Title(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.task_title(next)));
			return obj;
		}
		Title_field(){
			const obj = new this.$.$mol_form_field();
		...
		Item_text(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ("Предложение");
			(obj.value) = (next) => ((this.item_text(id, next)));
			return obj;
		}
		item_key(id, next){
			if(next !== undefined) return next;
		...
		item_rows(){
			return [(this.Item_row(id)), (this.Item_add())];
		}
		Items(){
			const obj = new this.$.$mol_list();
		...
		Tools(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Current()), (this.Home())]);
			return obj;
		}
		content(){
			return [(this.Title_field()), (this.Items())];
		}
	};
	($mol_mem(($.$bog_stschool_edit.prototype), "current"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Current"));
	($mol_mem(($.$bog_stschool_edit.prototype), "home"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Home"));
	($mol_mem(($.$bog_stschool_edit.prototype), "task_title"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Title"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Title_field"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "Item_numb"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "item_text"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "Item_text"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "item_key"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "Item_key"));
	($mol_mem_key(($.$bog_stschool_edit.prototype), "Item_row"));
	($mol_mem(($.$bog_stschool_edit.prototype), "item_add"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Item_add"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Items"));
	($mol_mem(($.$bog_stschool_edit.prototype), "Tools"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_edit extends $.$bog_stschool_edit {
            room() {
            ...
            current(next) {
                if (next !== undefined)
                    this.room().current_link(next ? this.task_link() : '');
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_edit.prototype, "item_numb", null);
        $$.$bog_stschool_edit = $bog_stschool_edit;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_teach) = class $bog_stschool_teach extends ($.$mol_page) {
		group_title(next){
			if(next !== undefined) return next;
			return "Группа";
		}
		Stream_link(){
			...
			(obj.title) = () => ("Стрим");
			(obj.target) = () => ("_blank");
			(obj.arg) = () => ({"group": (this.link()), "screen": "stream"});
			return obj;
		}
		Check_link(){
			const obj = new this.$.$mol_link();
		...
		Invite_uri(){
			const obj = new this.$.$mol_string();
			(obj.enabled) = () => (false);
			(obj.value) = () => ((this.invite_uri()));
			return obj;
		}
		Invite_copy(){
			const obj = new this.$.$mol_button_copy();
			(obj.title) = () => ("Скопировать");
			(obj.text) = () => ((this.invite_uri()));
			return obj;
		}
		Invite(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Invite_uri()), (this.Invite_copy())]);
			return obj;
		}
		Invite_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ("Ссылка для учеников");
			(obj.Content) = () => ((this.Invite()));
			return obj;
		}
		task_link(id){
			return "";
		...
		Task_row(id){
			const obj = new this.$.$bog_stschool_edit();
			(obj.room_link) = () => ((this.link()));
			(obj.task_link) = () => ((this.task_link(id)));
			return obj;
		}
		task_add(next){
			if(next !== undefined) return next;
		...
		Task_add(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Новое задание");
			(obj.click) = (next) => ((this.task_add(next)));
			return obj;
		}
		task_rows(){
			return [(this.Task_row(id)), (this.Task_add())];
		}
		Tasks(){
			const obj = new this.$.$mol_list();
		...
		Deck_title(id){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this.deck_title(id, next)));
			return obj;
		}
		deck_drop(id, next){
			if(next !== undefined) return next;
		...
		Deck_drop(id){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Убрать");
			(obj.click) = (next) => ((this.deck_drop(id, next)));
			return obj;
		}
		Deck_row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Deck_title(id)), (this.Deck_drop(id))]);
			return obj;
		}
		deck_files(next){
			if(next !== undefined) return next;
		...
		deck_rows(){
			return [(this.Deck_row(id)), (this.Deck_add())];
		}
		Decks(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.deck_rows()));
			return obj;
		}
		Decks_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ("Презентации");
			(obj.Content) = () => ((this.Decks()));
			return obj;
		}
		members_name(){
			return "Ученики";
		...
		tools(){
			return [(this.Stream_link()), (this.Check_link())];
		}
		body(){
			return [
				(this.Title_field()), 
	...
	($mol_mem(($.$bog_stschool_teach.prototype), "Invite"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Invite_field"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "Task_row"));
	($mol_mem(($.$bog_stschool_teach.prototype), "task_add"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Task_add"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Tasks"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Tasks_field"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "deck_title"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "Deck_title"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "deck_drop"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "Deck_drop"));
	($mol_mem_key(($.$bog_stschool_teach.prototype), "Deck_row"));
	($mol_mem(($.$bog_stschool_teach.prototype), "deck_files"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Deck_add"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Decks"));
	($mol_mem(($.$bog_stschool_teach.prototype), "Decks_field"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_teach extends $.$bog_stschool_teach {
            room() {
                return $bog_stschool_room.of(this.link());
            }
            group_title(next) {
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_teach.prototype, "task_link", null);
        __decorate([
            $mol_mem_key
...
;
	($.$bog_stschool_answer) = class $bog_stschool_answer extends ($.$mol_list) {
		answer_rows(){
			return [];
		}
		task_title(){
		...
		rows(){
			return (this.answer_rows());
		}
		Title(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.task_title()));
			return obj;
		}
		Item_row(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.item_sub(id)));
			return obj;
		}
		Item_text(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.item_text(id)));
			return obj;
		}
		Item_last(id){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({"bog_stschool_answer_mark": (this.item_mark(id))});
			(obj.sub) = () => ([(this.item_last(id))]);
			return obj;
		}
		Item_key(id){
			const obj = new this.$.$mol_paragraph();
		...
		Item_input(id){
			const obj = new this.$.$mol_string();
			(obj.hint) = () => ("Ваш ответ, Enter чтобы отправить");
			(obj.value) = (next) => ((this.item_draft(id, next)));
			(obj.submit) = (next) => ((this.item_send(id, next)));
			return obj;
		}
		Item_history(id){
			const obj = new this.$.$mol_expander();
			(obj.title) = () => ("История");
			(obj.content) = () => ((this.item_history(id)));
			return obj;
		}
		History_row(id){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({"bog_stschool_answer_mark": (this.history_mark(id))});
			(obj.sub) = () => ([(this.history_text(id))]);
			return obj;
		}
		Send(){
			const obj = new this.$.$mol_button_major();
			(obj.title) = () => ("Сдать домашку");
			(obj.click) = (next) => ((this.send(next)));
			return obj;
		}
		Sent(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.sent_text()));
			return obj;
		}
	};
	($mol_mem_key(($.$bog_stschool_answer.prototype), "item_draft"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "item_send"));
	($mol_mem(($.$bog_stschool_answer.prototype), "send"));
	($mol_mem(($.$bog_stschool_answer.prototype), "Title"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_row"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_text"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_last"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_key"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_input"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "Item_history"));
	($mol_mem_key(($.$bog_stschool_answer.prototype), "History_row"));
	($mol_mem(($.$bog_stschool_answer.prototype), "Send"));
	($mol_mem(($.$bog_stschool_answer.prototype), "Sent"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_answer extends $.$bog_stschool_answer {
            room() {
                return $bog_stschool_room.of(this.room_link());
            }
            task() {
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_sub", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_key", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_last", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_mark", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_draft", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "item_history", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "history_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_answer.prototype, "history_mark", null);
        $$.$bog_stschool_answer = $bog_stschool_answer;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_study) = class $bog_stschool_study extends ($.$mol_page) {
		group_title(){
			return "Группа";
		}
		Status(){
		...
		Current_head(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Сейчас на занятии");
			return obj;
		}
		Current(){
			const obj = new this.$.$bog_stschool_answer();
			(obj.room_link) = () => ((this.link()));
			(obj.task_link) = () => ((this.current_link()));
			(obj.student_link) = () => ((this.student_link()));
			return obj;
		}
		Nothing(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Учитель ещё не открыл задание");
			return obj;
		}
		Home_head(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Домашние задания");
			return obj;
		}
		Home_row(id){
			const obj = new this.$.$bog_stschool_answer();
			(obj.room_link) = () => ((this.link()));
			(obj.task_link) = () => ((this.home_link(id)));
			(obj.student_link) = () => ((this.student_link()));
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_study.prototype), "Status"));
	($mol_mem(($.$bog_stschool_study.prototype), "Current_head"));
	($mol_mem(($.$bog_stschool_study.prototype), "Current"));
	($mol_mem(($.$bog_stschool_study.prototype), "Nothing"));
	($mol_mem(($.$bog_stschool_study.prototype), "Home_head"));
	($mol_mem_key(($.$bog_stschool_study.prototype), "Home_row"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_study extends $.$bog_stschool_study {
            room() {
                return $bog_stschool_room.of(this.link());
            }
            group_title() {
        ...
        __decorate([
            $mol_mem
        ], $bog_stschool_study.prototype, "home_links", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_study.prototype, "home_link", null);
        $$.$bog_stschool_study = $bog_stschool_study;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_board) = class $bog_stschool_board extends ($.$mol_view) {
		tool(next){
			if(next !== undefined) return next;
			return "pen";
		}
		...
		Stroke(id){
			const obj = new this.$.$mol_svg_path();
			(obj.geometry) = () => ((this.stroke_geometry(id)));
			(obj.attr) = () => ({...(this.$.$mol_svg_path.prototype.attr.call(obj)), "stroke": (this.stroke_color(id))});
			return obj;
		}
		strokes(){
		...
		Text(id){
			const obj = new this.$.$bog_stschool_board_area();
			(obj.value) = (next) => ((this.text_value(id, next)));
			(obj.style) = () => ({"left": (this.text_x(id)), "top": (this.text_y(id))});
			return obj;
		}
		texts(){
			return [(this.Text(id))];
		...
		Sheet(){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({...(this.$.$mol_view.prototype.attr.call(obj)), "bog_stschool_board_tool": (this.tool())});
			(obj.event) = () => ({
				"pointerdown": (next) => (this.down(next)), 
				"pointermove": (next) => (this.move(next)), 
				"pointerup": (next) => (this.up(next)), 
				"pointercancel": (next) => (this.up(next)), 
				"dblclick": (next) => (this.text_add(next))
			});
			(obj.sub) = () => ([(this.Paper()), (this.Texts())]);
			return obj;
		}
		value(next){
			if(next !== undefined) return next;
		...
		sub(){
			return [(this.Tools()), (this.Sheet())];
		}
	};
	($mol_mem(($.$bog_stschool_board.prototype), "tool"));
	($mol_mem(($.$bog_stschool_board.prototype), "Tool"));
	($mol_mem(($.$bog_stschool_board.prototype), "color"));
	($mol_mem(($.$bog_stschool_board.prototype), "Color"));
	($mol_mem(($.$bog_stschool_board.prototype), "clear"));
	($mol_mem(($.$bog_stschool_board.prototype), "Clear"));
	($mol_mem(($.$bog_stschool_board.prototype), "Tools"));
	($mol_mem(($.$bog_stschool_board.prototype), "down"));
	($mol_mem(($.$bog_stschool_board.prototype), "move"));
	($mol_mem(($.$bog_stschool_board.prototype), "up"));
	($mol_mem(($.$bog_stschool_board.prototype), "text_add"));
	($mol_mem_key(($.$bog_stschool_board.prototype), "Stroke"));
	($mol_mem(($.$bog_stschool_board.prototype), "Paper"));
	($mol_mem_key(($.$bog_stschool_board.prototype), "text_value"));
	($mol_mem_key(($.$bog_stschool_board.prototype), "Text"));
	($mol_mem(($.$bog_stschool_board.prototype), "Texts"));
	($mol_mem(($.$bog_stschool_board.prototype), "Sheet"));
	($mol_mem(($.$bog_stschool_board.prototype), "value"));
	($.$bog_stschool_board_area) = class $bog_stschool_board_area extends ($.$mol_string) {
		dom_name(){
			return "textarea";
		}
		hint(){
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $bog_stschool_board extends $.$bog_stschool_board {
            data() {
                try {
            ...
            text_value(index, next) {
                if (next === undefined)
                    return this.data().t[index]?.t ?? '';
                const data = this.data();
            ...
            erase(x, y) {
                ...
                if (kept.length === data.s.length)
                    return;
                this.save({ ...data, s: kept });
            }
            hit(stroke, x, y) {
                for (let i = 0; i < stroke.p.length; i += 2) {
                    if (Math.hypot(stroke.p[i] - x, stroke.p[i + 1] - y) < 12)
                        return true;
                }
                return false;
            }
        ...
        __decorate([
            $mol_mem
        ], $bog_stschool_board.prototype, "data", null);
        __decorate([
            $mol_mem
        ], $bog_stschool_board.prototype, "draft", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_board.prototype, "stroke_geometry", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_board.prototype, "stroke_color", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_board.prototype, "text_x", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_board.prototype, "text_y", null);
        $$.$bog_stschool_board = $bog_stschool_board;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $mol_style_attach("bog/stschool/board/board.view.css", "[bog_stschool_board_stroke] {\n\tfill: none;\n\tstroke-width: 3px;\n\tstroke-linecap: round;\n\tstroke-linejoin: round;\n}\n");
})($ || ($ = {}));
...
;
	($.$bog_stschool_slides) = class $bog_stschool_slides extends ($.$mol_view) {
		keys_action(){
			return {};
		}
		Keys(){
			const obj = new this.$.$mol_hotkey2();
			(obj.action) = () => ((this.keys_action()));
			return obj;
		}
		stage(){
			return [];
		...
		Insert(){
			const obj = new this.$.$mol_button_minor();
			(obj.title) = () => ("Вставить слайд после");
		...
		Slide(){
			const obj = new this.$.$bog_stschool_board();
			(obj.value) = (next) => ((this.slide_board(next)));
			return obj;
		}
		Wait(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("Загружаем PDF…");
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_slides.prototype), "Keys"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Stage"));
	($mol_mem(($.$bog_stschool_slides.prototype), "prev"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Prev"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Numb"));
	($mol_mem(($.$bog_stschool_slides.prototype), "next"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Next"));
	($mol_mem(($.$bog_stschool_slides.prototype), "insert"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Insert"));
	($mol_mem(($.$bog_stschool_slides.prototype), "remove"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Remove"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Bar"));
	($mol_mem(($.$bog_stschool_slides.prototype), "slide_board"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Page"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Slide"));
	($mol_mem(($.$bog_stschool_slides.prototype), "Wait"));
...
(function ($) {
    ...
    class $bog_stschool_pdf extends $mol_object {
        bytes() {
            return new Uint8Array;
        }
        lib() {
            const lib = this.$.$mol_import.module(cdn + 'pdf.min.mjs');
        ...
        page_uri(numb) {
            const doc = this.doc();
            if (!doc || numb < 1 || numb > doc.numPages)
                return '';
            return $mol_wire_sync(this).page_render(doc, numb);
        }
        async page_render(doc, numb) {
    ...
    __decorate([
        $mol_mem
    ], $bog_stschool_pdf.prototype, "lib", null);
    __decorate([
        $mol_mem
    ], $bog_stschool_pdf.prototype, "doc", null);
    __decorate([
        $mol_mem_key
    ], $bog_stschool_pdf.prototype, "page_uri", null);
    $.$bog_stschool_pdf = $bog_stschool_pdf;
})($ || ($ = {}));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_slides extends $.$bog_stschool_slides {
            room() {
                return $bog_stschool_room.of(this.room_link());
            }
            deck() {
            ...
            steps() {
                ...
                for (let page = 0; page <= count; ++page) {
                    ...
                    for (const slide of slides) {
                        if ((slide.After()?.val() ?? 0) === page)
                            steps.push({ slide: slide.link().str });
                    }
                }
                return steps;
            }
            ...
            stage() {
                if (!this.file()?.buffer().byteLength)
                    return [this.Wait()];
                if (this.slide_link())
                    return [this.Slide()];
                return [this.Page()];
        ...
        __decorate([
            $mol_mem
        ], $bog_stschool_slides.prototype, "pdf", null);
        __decorate([
            $mol_mem
        ], $bog_stschool_slides.prototype, "steps", null);
        __decorate([
            $mol_mem
        ], $bog_stschool_slides.prototype, "pos", null);
        $$.$bog_stschool_slides = $bog_stschool_slides;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_stream) = class $bog_stschool_stream extends ($.$mol_view) {
		task_title(){
			return "";
		}
		Task_title(){
		...
		Task_item(id){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.task_item(id)));
			return obj;
		}
		task_sub(){
			return [(this.Task_title()), (this.Task_item(id))];
		}
		Task(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ((this.task_sub()));
			return obj;
		}
		stage(){
			return [];
		...
		Board(){
			const obj = new this.$.$bog_stschool_board();
			(obj.value) = (next) => ((this.board(next)));
			return obj;
		}
		Slides(id){
			const obj = new this.$.$bog_stschool_slides();
			(obj.room_link) = () => ((this.link()));
			(obj.deck_link) = () => ((this.deck_link(id)));
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_stream.prototype), "Task_title"));
	($mol_mem_key(($.$bog_stschool_stream.prototype), "Task_item"));
	($mol_mem(($.$bog_stschool_stream.prototype), "Task"));
	($mol_mem(($.$bog_stschool_stream.prototype), "Stage"));
	($mol_mem(($.$bog_stschool_stream.prototype), "tab"));
	($mol_mem(($.$bog_stschool_stream.prototype), "Tabs"));
	($mol_mem(($.$bog_stschool_stream.prototype), "board"));
	($mol_mem(($.$bog_stschool_stream.prototype), "Board"));
	($mol_mem_key(($.$bog_stschool_stream.prototype), "Slides"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_stream extends $.$bog_stschool_stream {
            room() {
                return $bog_stschool_room.of(this.link());
            }
            task() {
            ...
            tab_options() {
                const options = { board: 'Доска' };
                for (const deck of this.room().decks())
                    options[deck.link().str] = deck.Title()?.val() || 'PDF';
                return options;
            }
            deck_link(link) {
                return link;
            ...
            stage() {
                const tab = this.tab();
                if (tab === 'board' || !this.room().deck(tab))
                    return [this.Board()];
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_stream.prototype, "task_item", null);
        __decorate([
            $mol_mem
        ], $bog_stschool_stream.prototype, "tab_options", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_stream.prototype, "deck_link", null);
        $$.$bog_stschool_stream = $bog_stschool_stream;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_cell) = class $bog_stschool_cell extends ($.$mol_view) {
		mark(){
			return "";
		}
		cell_sub(){
		...
		Bad(){
			const obj = new this.$.$mol_check_box();
			(obj.title) = () => ("неверно");
			(obj.checked) = (next) => ((this.bad(next)));
			return obj;
		}
		history_title(){
			return "";
		...
		attr(){
			return {...(super.attr()), "bog_stschool_cell_mark": (this.mark())};
		}
		sub(){
			return (this.cell_sub());
		}
		Text(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ((this.text()));
		...
		Marks(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Ok()), (this.Bad())]);
			return obj;
		}
		History(){
			const obj = new this.$.$mol_expander();
			(obj.title) = () => ((this.history_title()));
			(obj.content) = () => ((this.history()));
			return obj;
		}
		History_row(id){
			const obj = new this.$.$mol_view();
			(obj.attr) = () => ({"bog_stschool_cell_mark": (this.history_mark(id))});
			(obj.sub) = () => ([(this.history_text(id))]);
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_cell.prototype), "ok"));
	($mol_mem(($.$bog_stschool_cell.prototype), "Ok"));
	($mol_mem(($.$bog_stschool_cell.prototype), "bad"));
	($mol_mem(($.$bog_stschool_cell.prototype), "Bad"));
	($mol_mem(($.$bog_stschool_cell.prototype), "Text"));
	($mol_mem(($.$bog_stschool_cell.prototype), "Empty"));
	($mol_mem(($.$bog_stschool_cell.prototype), "Marks"));
	($mol_mem(($.$bog_stschool_cell.prototype), "History"));
	($mol_mem_key(($.$bog_stschool_cell.prototype), "History_row"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_cell extends $.$bog_stschool_cell {
            room() {
                return $bog_stschool_room.of(this.room_link());
            }
            replies() {
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_cell.prototype, "history_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_cell.prototype, "history_mark", null);
        $$.$bog_stschool_cell = $bog_stschool_cell;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_check) = class $bog_stschool_check extends ($.$mol_page) {
		group_title(){
			return "Проверка";
		}
		task_options(){
		...
		Task_pick(){
			...
			(obj.hint) = () => ("Задание");
			(obj.options) = () => ((this.task_options()));
			(obj.dictionary) = () => ((this.task_dictionary()));
			(obj.value) = (next) => ((this.task_link(next)));
			return obj;
		}
		Status(){
			const obj = new this.$.$giper_baza_status();
		...
		Student_name(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.student_name(id)), (this.student_sent(id))]);
			return obj;
		}
		cell_student(id){
			return "";
		...
		Cell(id){
			const obj = new this.$.$bog_stschool_cell();
			(obj.room_link) = () => ((this.link()));
			(obj.task_link) = () => ((this.task_link()));
			(obj.student_link) = () => ((this.cell_student(id)));
			(obj.item) = () => ((this.cell_item(id)));
			return obj;
		}
		grid_rows(){
			return [
		...
		tools(){
			return [(this.Task_pick()), (this.Status())];
		}
		body(){
			return (this.body_rows());
		}
		Grid(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.grid_rows()));
			return obj;
		}
		Nobody(){
			const obj = new this.$.$mol_paragraph();
			(obj.title) = () => ("В группе пока нет учеников");
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_check.prototype), "task_link"));
	($mol_mem(($.$bog_stschool_check.prototype), "Task_pick"));
	...
	($mol_mem(($.$bog_stschool_check.prototype), "Grid"));
	($mol_mem(($.$bog_stschool_check.prototype), "Nobody"));
...
(function ($) {
    var $$;
    (function ($$) {
        class $bog_stschool_check extends $.$bog_stschool_check {
            room() {
                return $bog_stschool_room.of(this.link());
            }
            group_title() {
            ...
            task_dictionary() {
                const dict = {};
                for (const task of this.room().tasks())
                    dict[task.link().str] = task.Title()?.val() ?? '';
                return dict;
            }
            task_link(next) {
        ...
        __decorate([
            $mol_mem
        ], $bog_stschool_check.prototype, "task_dictionary", null);
        __decorate([
            $mol_mem
        ], $bog_stschool_check.prototype, "task_link", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "item_text", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "student_cells", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "student_name", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "student_sent", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "cell_student", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_check.prototype, "cell_item", null);
        $$.$bog_stschool_check = $bog_stschool_check;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$bog_stschool_app) = class $bog_stschool_app extends ($.$mol_view) {
		Theme(){
			const obj = new this.$.$bog_theme_auto();
		...
		Teach_link(id){
			...
			(obj.arg) = () => ({"group": (this.group_link(id))});
			return obj;
		}
		teach_rows(){
			return [(this.Teach_link(id))];
		}
		Teach_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.teach_rows()));
			return obj;
		}
		group_add(next){
			if(next !== undefined) return next;
		...
		Group_add(){
			...
			(obj.click) = (next) => ((this.group_add(next)));
			return obj;
		}
		Teach(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Teach_list()), (this.Group_add())]);
			return obj;
		}
		Teach_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ("Веду группы");
			(obj.Content) = () => ((this.Teach()));
			return obj;
		}
		Learn_link(id){
			const obj = new this.$.$mol_link();
		...
		learn_rows(){
			return [(this.Learn_link(id))];
		}
		Learn_list(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ((this.learn_rows()));
			return obj;
		}
		Learn_field(){
			const obj = new this.$.$mol_form_field();
			(obj.name) = () => ("Учусь");
			(obj.Content) = () => ((this.Learn_list()));
			return obj;
		}
		join_link(){
			return "";
		...
		Home(){
			...
			(obj.title) = () => ("Уроки");
			(obj.tools) = () => ([(this.Status()), (this.Theme_toggle())]);
			(obj.body) = () => ([
				(this.Name_field()), 
				(this.Teach_field()), 
				(this.Learn_field())
		...
		Join(){
			const obj = new this.$.$bog_stschool_join();
			(obj.link) = () => ((this.join_link()));
			return obj;
		}
		Teach_page(){
			const obj = new this.$.$bog_stschool_teach();
			(obj.link) = () => ((this.group_link_current()));
			return obj;
		}
		Study(){
			const obj = new this.$.$bog_stschool_study();
			(obj.link) = () => ((this.group_link_current()));
			return obj;
		}
		Stream(){
			const obj = new this.$.$bog_stschool_stream();
			(obj.link) = () => ((this.group_link_current()));
			return obj;
		}
		Check(){
			const obj = new this.$.$bog_stschool_check();
			(obj.link) = () => ((this.group_link_current()));
			return obj;
		}
	};
	($mol_mem(($.$bog_stschool_app.prototype), "Theme"));
	($mol_mem(($.$bog_stschool_app.prototype), "Status"));
	($mol_mem(($.$bog_stschool_app.prototype), "Theme_toggle"));
	($mol_mem(($.$bog_stschool_app.prototype), "name"));
	($mol_mem(($.$bog_stschool_app.prototype), "Name"));
	($mol_mem(($.$bog_stschool_app.prototype), "Name_field"));
	($mol_mem_key(($.$bog_stschool_app.prototype), "Teach_link"));
	($mol_mem(($.$bog_stschool_app.prototype), "Teach_list"));
	($mol_mem(($.$bog_stschool_app.prototype), "group_add"));
	($mol_mem(($.$bog_stschool_app.prototype), "Group_add"));
	($mol_mem(($.$bog_stschool_app.prototype), "Teach"));
	($mol_mem(($.$bog_stschool_app.prototype), "Teach_field"));
	($mol_mem_key(($.$bog_stschool_app.prototype), "Learn_link"));
	($mol_mem(($.$bog_stschool_app.prototype), "Learn_list"));
	($mol_mem(($.$bog_stschool_app.prototype), "Learn_field"));
	($mol_mem(($.$bog_stschool_app.prototype), "Book"));
	($mol_mem(($.$bog_stschool_app.prototype), "Home"));
	($mol_mem(($.$bog_stschool_app.prototype), "Join"));
	($mol_mem(($.$bog_stschool_app.prototype), "Teach_page"));
	($mol_mem(($.$bog_stschool_app.prototype), "Study"));
	($mol_mem(($.$bog_stschool_app.prototype), "Stream"));
	($mol_mem(($.$bog_stschool_app.prototype), "Check"));
    ...
    (function ($$) {
        class $bog_stschool_app extends $.$bog_stschool_app {
            ...
            screens() {
                ...
                if (group && this.screen() === 'stream')
                    return [this.Stream()];
                if (group && this.screen() === 'check')
                    return [this.Check()];
                return [this.Book()];
            }
            pages() {
        ...
        __decorate([
            $mol_mem_key
        ], $bog_stschool_app.prototype, "group_title", null);
        __decorate([
            $mol_mem_key
        ], $bog_stschool_app.prototype, "group_link", null);
        $$.$bog_stschool_app = $bog_stschool_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
